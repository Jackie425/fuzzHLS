...
AUTOPILOT_ROOT := /home/jackie/Xilinx/Vivado/2019.1
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /home/jackie/Xilinx/Vivado/2019.1/tps/lnx64/gcc-6.2.0/bin
endif
...
IFLAG += -D__SIM_DDS__
IFLAG += -D__DSP48E2__
IFLAG += -I/home/jackie/csmith/include -Wno-unknown-pragmas
...
$(ObjDir)/testbench.c_pre.c.tb.o : testbench.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) testbench.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/fuzzHLS.c_pre.c.tb.o : fuzzHLS.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) fuzzHLS.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
